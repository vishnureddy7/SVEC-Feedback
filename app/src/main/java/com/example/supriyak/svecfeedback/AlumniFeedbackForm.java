    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(AlumniFeedbackForm.this,x,Toast.LENGTH_LONG).show();
                ...
                db.collection("Alumni Feedback")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(AlumniFeedbackForm.this,"Successfully registered",Toast.LENGTH_LONG).show();
...
//                                startActivity(thankyou);
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(AlumniFeedbackForm.this,"Error while Registering. Please try again later.",Toast.LENGTH_LONG).show();
                            }
                        });
            }
        });
